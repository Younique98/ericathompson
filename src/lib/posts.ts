...
export const posts: Post[] = [
  {
    slug: "400-daily-404s-technical-audits",
    title: "What 400 Daily 404s Taught Me About Technical Audits",
    date: "August 2026",
    excerpt:
      "The errors were not 400 separate problems. They were three systemic ones — and that's the entire argument for a fixed-scope audit over ongoing firefighting.",
    body: [
  ...
  {
    slug: "accessibility-is-not-a-checkbox",
    title: "Accessibility Is Not a Checkbox. It Is $500K.",
    date: "August 2026",
    excerpt:
      "A company I worked with faced an active accessibility lawsuit threat, over half a million dollars in exposure, and a due diligence process about to surface all of it.",
    body: [
  ...
  {
    slug: "self-taught-to-staff-level",
    title: "Self-Taught to Staff Level: What Actually Transfers",
    date: "August 2026",
    excerpt:
      "Credentials got none of my students hired. Judgment did — the ability to read an unfamiliar codebase, form a hypothesis, and test it cheaply.",
    body: [
  ...
  {
    slug: "compliance-deadline-that-could-have-ended-the-company",
    title: "The Compliance Deadline That Could Have Ended the Company",
    date: "August 2026",
    excerpt:
      "$12.5M in annual revenue and 20K+ active policies on the line, a regulatory deadline, and zero room for disruption. It shipped 10 days early.",
    body: [
  ...
  {
    slug: "the-tool-that-still-runs-years-after-i-left",
    title: "The Tool That Still Runs Years After I Left",
    date: "August 2026",
    excerpt:
      "Not 'did it work at launch' but 'does it still run after the author leaves.' That's my actual test for infrastructure work.",
    body: [
  ...
  {
    slug: "how-to-run-a-migration-nobody-notices",
    title: "How to Run a Migration Nobody Notices",
    date: "August 2026",
    excerpt:
      "Never migrate and change at the same time. Feature parity first, improvement second — the pattern behind three zero-disruption platform migrations.",
    body: [
  ...
  {
    slug: "build-the-tool-that-makes-your-team-stop-needing-you",
    title: "Build the Tool That Makes Your Team Stop Needing You",
    date: "August 2026",
    excerpt:
      "The counterintuitive lesson for engineers worried about making themselves unnecessary: dependency is not job security. Leverage is.",
    body: [
  ...
  {
    slug: "what-being-the-go-to-person-actually-costs-and-earns",
    title: "What Being the Go-To Person Actually Costs, and Earns",
    date: "August 2026",
    excerpt:
      "You learn systems by being handed their worst days. The work makes you valuable. The record you keep makes you paid.",
    body: [
...
export function readTimeFor(post: Post) {
